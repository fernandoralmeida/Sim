...
namespace Sim.Modulos.Accounts.Model
{
    ...
    public class mData
    {
                ...
                {                    
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        if (_acc.Conta.Conta == (int)AccountAccess.Bloqueado)
                        {
                            ...
                            _acc.Modulos = md;
                            smd.Add(new mSubModulos { Indice = 0, Identificador = _acc.Identificador, SubModulo = (int)SubModulo.Legislacao, Acesso = (int)SubModuloAccess.Consulta });
                            smd.Add(new mSubModulos { Indice = 0, Identificador = _acc.Identificador, SubModulo = (int)SubModulo.Portarias, Acesso = (int)SubModuloAccess.Consulta });
                            smd.Add(new mSubModulos { Indice = 0, Identificador = _acc.Identificador, SubModulo = (int)SubModulo.Contratos, Acesso = (int)SubModuloAccess.Consulta });
                            smd.Add(new mSubModulos { Indice = 0, Identificador = _acc.Identificador, SubModulo = (int)SubModulo.Denominacoes, Acesso = (int)SubModuloAccess.Consulta });
        ...
        private string CodigoAcesso()
        {
            ...
            r = string.Format(@"{0}_{1}{2}{3}{4}{5}{6}", AccountOn.Identificador, a, m, d, hs, mn, ss);
        ...
        {
            var dbLogin = Data.Instances.DataA();
