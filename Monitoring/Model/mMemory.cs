...
namespace Sim.Monitoring.Model
{
    ...
    public class mMemory : NotifyProperty
    {
        ...
        public string Physic { get { return _physic; }
            set { _physic = value;
            RaisePropertyChanged("Physic");
            }
        }

        public string Used { get { return _used; }
            set { _used = value;
            RaisePropertyChanged("Used");
            }
        }

        public string Pagined { get { return _pagined; }
            set { _pagined = value;
