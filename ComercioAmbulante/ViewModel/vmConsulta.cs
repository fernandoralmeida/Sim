    ...
    class vmConsulta : NotifyProperty
    {
        ...
        private void ExecCommandAlterar(object obj)
        {
            try
            {
                ...
                {
                    ns.Navigate(new Uri(@"/Sim.Modulo.Empreendedor;component/View/Atendimento/pEdicao.xaml", UriKind.Relative));
        ...
        public vmConsulta()
        {
            Mvvm.Helpers.Observers.GlobalNavigation.Pagina = "CONSULTA ATENDIMENTOS";
        ...
        private List<string> Parametros()
        {
            ...
            else
            {
                ...
                _param.Add(Tipos[GetTipos -1].Nome);
                Filtros.Add("[TIPO = ]" + Tipos[GetTipos -1].Nome);
            }
