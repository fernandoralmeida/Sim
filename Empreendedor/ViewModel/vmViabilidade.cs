...
namespace Sim.Modulos.Empreendedor.ViewModel
{
    ...
    using Data.OnLine.ReceitaFederal;
    ...
    class vmViabilidade : NotifyProperty
    {
        ...
        public vmViabilidade()
        {
            ...
            MailBox = Visibility.Collapsed;
            CnaeBox = Visibility.Collapsed;
            MailTo = @"aprovacao.obras@jau.sp.gov.br";
        ...
        private void GravarDados(Registro tipo)
        {
            try
            {
                ...
                Viabilidade.Operador = Accounts.AccountOn.Identificador;
        ...
        private void CreateMail()
        {
            ...
            sb.AppendLine(string.Format(@"{0}", Accounts.AccountOn.Nome));
            ...
            try
            {
                ...
                if (obj == null)
                {
                    if (MessageBox.Show("CLIENTE " + Viabilidade.Requerente.Inscricao + " não encontrado! Cadastrá-lo agora?", "Sim.Alerta!", MessageBoxButton.YesNo, MessageBoxImage.Asterisk) == MessageBoxResult.Yes)
                    {
                        ...
                        GlobalNavigation.Navegar = new Uri("/Sim.Modulo.Empreendedor;component/View/pAddPJ.xaml", UriKind.Relative);
                        AreaTransferencia.CNPJ = Viabilidade.Requerente.Inscricao;
                    }
