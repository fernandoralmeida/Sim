    ...
    class vmSearch : NotifyProperty
    {
        ...
        private void ExecCommandAlterar(object obj)
        {
            try
            {
                ...
                {
                    ns.Navigate(new Uri(@"/Sim.Modulo.Empreendedor;component/View/Agenda/pEdite.xaml", UriKind.Relative));
        ...
        public vmSearch()
        {
            Mvvm.Helpers.Observers.GlobalNavigation.Pagina = "CONSULTA EVENTOS";
