...
namespace Sim.Modulos.Empreendedor.ViewModel
{
    ...
    class vmAtendimento : NotifyProperty
    {
        ...
        System.Data.DataTable _tipo = Data.Instances.DataM1().Read("SELECT * FROM SDT_Atendimento_Tipos ORDER BY Valor");
        ...
        private void ExecuteCommandViabilidade(object obj)
        {
            switch(Atendimento.Tipo)
            {
                ...
                case 10:
                    ...
                    AreaTransferencia.CPF = Atendimento.Cliente.Inscricao;
                    ns.Navigate(new Uri("/Sim.Modulo.Empreendedor;component/View/pViabilidade.xaml", UriKind.Relative));
                    break;
