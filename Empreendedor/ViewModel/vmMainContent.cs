...
namespace Sim.Modulos.Empreendedor.ViewModel
{
    ...
    class vmMainContent : NotifyProperty
    {
        ...
        private void AsyncMessageBox(string message)
        {
            ...
            Task.Factory.StartNew(() => Freezetime(5)).ContinueWith(taskmsg =>
            {
        ...
        private void GravarAtendimentoSebrae()
        {
            ...
            try
            {
                Task.Factory.StartNew(() => mdata.GravarAtendimentoSebrae(AtSebrae)).ContinueWith(task => {
